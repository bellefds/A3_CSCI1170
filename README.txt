...
Very little of this code was changed from the past assignments. Certain things were removed like the contact form as I would be implementing features that would make it redundant. I had 
to remove the mp4 used on the videos page in past assignments and replaced it with another YouTube video iframe tag because the file size was too large to upload to github.
